    ...
    override fun onCreateView(): ViewGroup {
        viewBinding = DialogBaseListBinding.inflate(LayoutInflater.from(context)).apply {
            ...
            layoutLoadableList.apply {
                setEmptyText(
                    R.string.message_empty_scenario_switch_list_title,
                    R.string.message_empty_scenario_switch_list_desc,
                )
...
private class ScenarioSwitchViewHolder(
    ...
    fun onBind(scenario: Scenario) {
        viewBinding.title.text = scenario.name
        viewBinding.description.text = itemView.context.resources.getQuantityString(
            R.plurals.item_desc_scenario_event_count,
            scenario.eventCount,
            scenario.eventCount,
        )
